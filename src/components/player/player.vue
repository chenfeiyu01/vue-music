        ...
        <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
          <div class="lyric-wrapper">
            <div v-if="currentLyric">
              <p class="text" :class="{'current': currentLineNum ===index}" ref="lyricLine" v-for="(line, index) in currentLyric.lines">
                {{line.txt}}
              </p>
            </div>
          </div>
      ...
      <div class="bottom">
        ...
        <div class="progress-wrapper">
          ...
          <div class="progress-bar-wrapper">
            <progress-bar :percent="percent" @percentChange="onProgressBarChange" @timeChange="onTimeChange"></progress-bar>
          </div>
  ...
  watch: {
    currentSong(newSong, oldSong) {
      ...
      setTimeout(() => {
        ...
        this.$refs.lyricList.$el.style[transform] = `translateX(${window.innerWidth}px)`
